...
type TeamSimple struct {
	...
	// City of team derived from parsing the address registered
	// with FIRST.
	City string `json:"city"`
	// State of team derived from parsing the address registered
	// with FIRST.
	StateProv string `json:"state_prov"`
	// Country of team derived from parsing the address registered
	// with FIRST.
	Country string `json:"country"`
}

func (t TeamSimple) String() string {
	return fmt.Sprintf("TeamNumber: %d\nNickname: %s", t.Number, t.Nickname)
}
...
type Team struct {
	...
	// Location of the team's home championship each year as a
	// key-value pair. The year (as a string) is the key, and the
	// city is the value.
